...
buildLevel :: (CaveKind -> Rnd (LMap, SecretMap, String))
              -> CaveKind -> Bool
              -> Rnd Level
...
bigRoom :: CaveKind -> Bool -> Rnd Level
bigRoom = buildLevel caveEmpty

caveEmpty :: CaveKind -> Rnd (LMap, SecretMap, String)
caveEmpty CaveKind{levelBound = (sx, sy)} =
...
noiseRoom :: CaveKind -> Bool -> Rnd Level
noiseRoom = buildLevel caveNoise

caveNoise :: CaveKind -> Rnd (LMap, SecretMap, String)
caveNoise cfg@(CaveKind{levelBound = (sx, sy)}) = do
...
rogueRoom :: CaveKind -> Bool -> Rnd Level
...
listArrayCfg :: CaveKind -> LMap -> TileMap
...
caveRogue :: CaveKind -> Rnd (LMap, SecretMap, String)
caveRogue cfg@(CaveKind {levelBound = (sx, sy)}) =
  do
