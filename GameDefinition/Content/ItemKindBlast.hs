...
explosionBlast n = ItemKind
  ...
  , ieffects = [RefillHP (- n `div` 2)]
               ...
               ++ [DropItem 1 COrgan "temporary conditions" | n >= 10]
               ++ [DropItem maxBound COrgan "impressed" | n >= 10]  -- shock
...
pheromone = ItemKind
  ...
  , idamage  = toDmg 0
  , iaspects = []
  , ieffects = [Impress, OverfillCalm (-10)]
...
youthSprinkle = ItemKind
  ...
  , idamage  = toDmg 0
  , iaspects = []
  , ieffects = [toOrganActorTurn "regenerating" (3 + d 3)]
  , ifeature = [toLinger 10, Fragile, Identified]
  , idesc    = ""
  , ikit     = []
  }
poisonCloud = ItemKind
  ...
  , idamage  = toDmg 0
  , iaspects = []
  , ieffects = [toOrganActorTurn "poisoned" (3 + d 3)]
  , ifeature = [toVelocity 10, Fragile, Identified]  -- 2 steps, 2 turns
  , idesc    = ""
  , ikit     = []
  }
mistAntiSlow = ItemKind
  ...
  , idamage  = toDmg 0
  , iaspects = []
  , ieffects = [DropItem 1 COrgan "slow 10"]
  , ifeature = [toVelocity 5, Fragile, Identified]  -- 1 step, 1 turn
  , idesc    = ""
  , ikit     = []
  }
mistAntidote = ItemKind
  ...
  , idamage  = toDmg 0
  , iaspects = []
  , ieffects = [DropItem maxBound COrgan "poisoned"]
  , ifeature = [toVelocity 5, Fragile, Identified]  -- 1 step, 1 turn
  , idesc    = ""
  , ikit     = []
  }
