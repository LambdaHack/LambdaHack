...
ambusher = warrior
  ...
  , ikit     = ikit warrior
               ++ [ ("weak arrow", CInv)  -- dark, so more kit without exploring
                  , ("add sight", CEqp)
                  , ("flask", CEqp)
                  , ("flask", CEqp) ]
  }
