...
signpostExit = ItemKind
  { isymbol  = 'O'
  , iname    = "signpost with exits"
  , ifreq    = [("signpost", 80)]
...
signpostMap = signpostExit
  { iname    = "signpost with map"
  , ifreq    = [("signpost", 20)]
  , ieffects = [Detect 10]
  }
fireSmall = ItemKind
