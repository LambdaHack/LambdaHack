...
largeTail = fist
  ...
  , icount   = 1
  , iverbApply   = "knock"
  , ieffects = [Hurt (9 * d 1) 0, PushActor 300 25]
  , idesc    = ""
  }
jaw = fist
  { iname    = "jaw"
