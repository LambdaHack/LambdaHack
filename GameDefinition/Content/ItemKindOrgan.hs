...
pupil = fist
  ...
  , ieffects = [ Recharging (DropItem 1 COrgan "temporary condition")
...
impressedMark10 = impressedMark
  { icount   = 10
  , ifreq    = [("impressed 10", 1)]
  }
