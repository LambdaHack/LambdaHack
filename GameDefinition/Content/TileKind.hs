...
floorDamp = floorArena
  ...
  , tfreq    = [ ("noiseSetLit", 600), ("noisePowerSetLit", 600)
               , ("damp stone floor Lit", 1), ("stair terminal Lit", 20) ]
  }
