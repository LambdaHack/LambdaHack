...
initPer = do
  ...
  (sactorAspect, sfovLucidLid, sfovClearLid, sfovLitLid, sperFid, sperCacheFid) <- getsState $ perFidInDungeon discoAspect
  modifyServer $ \ser -> ser {sactorAspect, sfovLucidLid, sfovClearLid, sfovLitLid, sperFid, sperCacheFid}
