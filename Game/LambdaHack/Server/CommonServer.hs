...
module Game.LambdaHack.Server.CommonServer
  ...
  , actorSkillsServer, maxActorSkillsServer, computeMaxTimeout
  ) where
...
computeMaxTimeout :: Time -> DiscoveryEffect -> ItemId -> ItemQuant
                  -> ItemQuant
computeMaxTimeout localTime discoEffect =
