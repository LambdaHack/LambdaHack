...
caveEmpty cops@Kind.COps{cocave=Kind.Ops{okind}}  _ ci =
...
caveNoise cops@Kind.COps{cocave=Kind.Ops{okind}}  _ ci = do
  let CaveKind{cxsize, cysize} = okind ci
      room = (1, 1, cxsize - 2, cysize - 2)
...
caveRogue cops@Kind.COps{cocave=Kind.Ops{okind}} n ci = do
