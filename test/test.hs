...
main :: IO ()
main =
  tieKnot $ tail $ words "dist/build/LambdaHack/LambdaHack --dbgMsgSer --newGame 2 --noAnim --maxFps 100000 --frontendNull --benchmark --stopAfterSeconds 1 --automateAll --keepAutomated --gameMode exploration --setDungeonRng 42 --setMainRng 42"
