...
arena = rogue
  ...
  , cminPlaceSize = rollDiceXY [(3, 2), (2, 1)] [(4, 1)]
...
empty = rogue
  ...
  , cgrid         = rollDiceXY [(2, 2)] [(1, 2)]
  , cminPlaceSize = rollDiceXY [(4, 3), (2, 1)] [(6, 1)]
...
noise = rogue
  ...
  , cgrid         = rollDiceXY [(2, 2)] [(1, 2)]
  , cminPlaceSize = rollDiceXY [(4, 2), (2, 1)] [(6, 1)]
...
combat = rogue
  ...
  , cname         = "Combat arena"
  , cfreq         = [("caveCombat", 1)]
  , cgrid         = rollDiceXY [(5, 2)] [(2, 2)]
  , cminPlaceSize = rollDiceXY [(3, 1)] [(3, 1)]
  , cdarkChance   = rollDeep (1, 100) (1, 100)
  , cvoidChance   = 1%8
  , cnonVoidMin   = 4
  , chidden       = 100
